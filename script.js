...
const formHandler = e => {
    ...
    const alertNotif = alertCheck => {
        const alertValidate = alertCheck === 'valid' ? window.confirm('Do you really want to add it') : window.confirm('The text must must be included # and at least 7 characters')
    }
    ...
    fetch(`${BASE_API_URL}/feedbacks`)
        ...
        })      // its return by default if we're not using {} in function
